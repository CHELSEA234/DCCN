...
parser.add_argument("--image", default="butterfly", type=str, help="image name")
...
im_gt_y = sio.loadmat("Set5_x2/" + opt.image + "_x2.mat")['im_gt_y']
im_b_y = sio.loadmat("Set5_x2/" + opt.image + "_x2.mat")['im_b_y']

...
def test_phase(model, scale, dataset='Set5'):
	...
	for i in range(len(image_name)):
		...
		im_gt_y = sio.loadmat("Set5_x2_2/" + image_name[i] + "_x2_2.mat")['im_gt_y']
		im_b_y = sio.loadmat("Set5_x2_2/" + image_name[i] + "_x2_2.mat")['im_b_y']
...
model = torch.load('pretrained/model_epoch_6_iteration_9600.pth')["model"]
psnr_value, ssim_value = test_phase(model, scale=2)
print ('''''''''''''''''''''''')
print ('psnr and ssim values are', psnr_value, ssim_value)
print ('''''''''''''''''''''''')
model = torch.load('pretrained/model_epoch_6_iteration_17364.pth')["model"]
psnr_value, ssim_value = test_phase(model, scale=2)
print ('''''''''''''''''''''''')
print ('psnr and ssim values are', psnr_value, ssim_value)
print ('''''''''''''''''''''''')
model = torch.load('pretrained/model_epoch_7_iteration_9600.pth')["model"]
psnr_value, ssim_value = test_phase(model, scale=2)
print ('''''''''''''''''''''''')
print ('psnr and ssim values are', psnr_value, ssim_value)
print ('''''''''''''''''''''''')
model = torch.load('pretrained/model_epoch_7_iteration_17364.pth')["model"]
psnr_value, ssim_value = test_phase(model, scale=2)
print ('''''''''''''''''''''''')
print ('psnr and ssim values are', psnr_value, ssim_value)
print ('''''''''''''''''''''''')
model = torch.load('pretrained/model_epoch_8_iteration_9600.pth')["model"]
psnr_value, ssim_value = test_phase(model, scale=2)
print ('''''''''''''''''''''''')
print ('psnr and ssim values are', psnr_value, ssim_value)
print ('''''''''''''''''''''''')

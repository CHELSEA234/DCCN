...
% folder = '/auto/rcf-proj2/jc/xiaoguo/SISR/train_dataset/Train_BSD3';
folder = '/auto/rcf-proj2/jc/xiaoguo/SISR/train_dataset/Train_BSD4';
...
% savepath = '/auto/rcf-proj2/jc/xiaoguo/SISR/train_dataset/Laplacian_x4/train_91.h5';
% savepath = '/auto/rcf-proj2/jc/xiaoguo/SISR/train_dataset/Laplacian_x4/train_BSD1_x4.h5';
% savepath = '/auto/rcf-proj2/jc/xiaoguo/SISR/train_dataset/Laplacian_x4/train_BSD2_x4.h5';
% savepath = '/auto/rcf-proj2/jc/xiaoguo/SISR/train_dataset/Laplacian_x4/train_BSD3_x4.h5';
savepath = '/auto/rcf-proj2/jc/xiaoguo/SISR/train_dataset/Laplacian_x4/train_BSD4_x4.h5';
...
data = zeros(size_input, size_input, 1, 1);     %   32 x 32
label_x2 = zeros(size_x2, size_x2, 1, 1);       %   64 x 64
        ...
        if size(image,3)==3
            ...
            for x = 1 + margain : stride : hei-size_label+1 - margain
                for y = 1 + margain :stride : wid-size_label+1 - margain
                    ...
                    label_x2(:, :, 1, count) = subim_label_x2;      %   64 x 64
...
label_x2 = label_x2(:, :, 1, order);    %   64 x 64
